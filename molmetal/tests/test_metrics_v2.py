...
# ---------------------------------------------------------------------------
def test_all_metrics_one_returns_8_keys():
    """``all_metrics_one`` must return a dict with exactly 8 keys."""
...
def test_all_metrics_mean_returns_8_keys():
    """``all_metrics_mean`` must return a dict with exactly 8 keys."""

...
- **Test AUC: 0.5268 ± 0.1346** (n=3 seeds: [42, 133, 256]).
- Bootstrap 95 % CI: **[0.4352, 0.6814]**.
- V3 reference: **0.4708** — V4 delta: **+0.0560** (+11.9 % relative).
- D-MPNN multitask baseline (Ru temporal, honest_baseline_summary.md): **0.5135** — V4 delta: **+0.0133** (+2.6 % relative).

## Per-seed results

| seed | params | best val AUC | best val PR | test AUC | test PR | test pIC50 MAE | wall-clock | avg epoch |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 42 | 1,193,031 | 0.7017 | 0.3896 | 0.4639 | 0.2988 | 0.7317 | 1047.3s | 34.9s |
| 133 | 1,193,031 | 0.7381 | 0.4181 | 0.4352 | 0.2644 | 0.7317 | 1003.9s | 33.5s |
| 256 | 1,193,031 | 0.8018 | 0.4278 | 0.6814 | 0.5813 | 0.7317 | 1007.9s | 33.6s |
...
- Mean: **0.5268**
- Std (sample, ddof=1): **0.1346**
- 95 % percentile CI: **[0.4352, 0.6814]**


## Conclusion

V4 improves on V3 (test AUC 0.4708) by +0.0560 (+11.9 % relative). It also exceeds the D-MPNN multitask baseline (0.5135) by +0.0133.

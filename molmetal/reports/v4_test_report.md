...
- **Test AUC: 0.5012 ± 0.0000** (n=1 seeds: [42]).
- Bootstrap 95 % CI: **[0.5012, 0.5012]**.
- V3 reference: **0.4708** — V4 delta: **+0.0304** (+6.5 % relative).
- D-MPNN multitask baseline (Ru temporal, honest_baseline_summary.md): **0.5135** — V4 delta: **-0.0123** (-2.4 % relative).

## Per-seed results

| seed | params | best val AUC | best val PR | test AUC | test PR | test pIC50 MAE | wall-clock | avg epoch |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 42 | 1,193,031 | 0.5589 | 0.2591 | 0.5012 | 0.2676 | 0.7317 | 50.0s | 50.0s |
...
- 95 % percentile CI: **[0.5012, 0.5012]**


## Conclusion

V4 improves on V3 (test AUC 0.4708) by +0.0304 (+6.5 % relative). It also falls below the D-MPNN multitask baseline (0.5135) by -0.0123.

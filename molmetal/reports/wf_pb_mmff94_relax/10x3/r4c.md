...
| test_000 | 0 | no_candidates | 0 | 0 | `` | 109.67 |
| test_000 | 1234 | no_candidates | 0 | 0 | `` | 4.54 |
| test_001 | 42 | seed_only | 1 | 0 | `COc1cc(OC)c(S(=O)(=O)NCc2ccccc2N2CCCCC2)cc1NC(C)=O` | 3.66 |
| test_001 | 0 | seed_only | 1 | 0 | `COc1cc(OC)c(S(=O)(=O)NCc2ccccc2N2CCCCC2)cc1NC(C)=O` | 3.78 |
| test_001 | 1234 | seed_only | 1 | 0 | `COc1cc(OC)c(S(=O)(=O)NCc2ccccc2N2CCCCC2)cc1NC(C)=O` | 3.75 |
| test_002 | 42 | no_candidates | 0 | 0 | `` | 3.29 |
| test_002 | 0 | no_candidates | 0 | 0 | `` | 3.28 |
| test_002 | 1234 | no_candidates | 0 | 0 | `` | 3.28 |
| test_003 | 42 | seed_only | 1 | 0 | `Nc1cc(S(O)(O)O)c(N)c2c1C(=O)c1ccccc1C2=O` | 3.58 |
| test_003 | 0 | seed_only | 1 | 0 | `Nc1cc(S(O)(O)O)c(N)c2c1C(=O)c1ccccc1C2=O` | 3.53 |
| test_003 | 1234 | seed_only | 1 | 0 | `Nc1cc(S(O)(O)O)c(N)c2c1C(=O)c1ccccc1C2=O` | 3.50 |
| test_004 | 42 | seed_only | 1 | 0 | `CC(C)NC[C@H](O)COc1cccc2ccccc12` | 3.59 |
| test_004 | 0 | seed_only | 1 | 0 | `CC(C)NC[C@H](O)COc1cccc2ccccc12` | 3.45 |
| test_004 | 1234 | seed_only | 1 | 0 | `CC(C)NC[C@H](O)COc1cccc2ccccc12` | 3.47 |
| test_005 | 42 | no_candidates | 0 | 0 | `` | 7.47 |
| test_005 | 0 | no_candidates | 0 | 0 | `` | 7.94 |
| test_005 | 1234 | no_candidates | 0 | 0 | `` | 7.50 |
| test_006 | 42 | seed_only | 1 | 0 | `C[C@H](CCC(N)=O)[C@H]1CC[C@H]2[C@@H]3C(=O)C[C@@H]4C[C@H](O)CC[C@]4(C)[C@H]3CC[C@]12C` | 3.74 |
| test_006 | 0 | seed_only | 1 | 0 | `C[C@H](CCC(N)=O)[C@H]1CC[C@H]2[C@@H]3C(=O)C[C@@H]4C[C@H](O)CC[C@]4(C)[C@H]3CC[C@]12C` | 3.62 |
| test_006 | 1234 | seed_only | 1 | 0 | `C[C@H](CCC(N)=O)[C@H]1CC[C@H]2[C@@H]3C(=O)C[C@@H]4C[C@H](O)CC[C@]4(C)[C@H]3CC[C@]12C` | 3.65 |
| test_007 | 42 | no_candidates | 0 | 0 | `` | 3.32 |
| test_007 | 0 | no_candidates | 0 | 0 | `` | 3.25 |
| test_007 | 1234 | no_candidates | 0 | 0 | `` | 3.20 |
| test_008 | 42 | seed_only | 1 | 0 | `Nc1ccc2nccn2c1` | 3.31 |
| test_008 | 0 | seed_only | 1 | 0 | `Nc1ccc2nccn2c1` | 3.34 |
| test_008 | 1234 | seed_only | 1 | 0 | `Nc1ccc2nccn2c1` | 3.26 |
| test_009 | 42 | no_candidates | 0 | 0 | `` | 3.25 |
| test_009 | 0 | no_candidates | 0 | 0 | `` | 3.37 |
| test_009 | 1234 | no_candidates | 0 | 0 | `` | 3.28 |

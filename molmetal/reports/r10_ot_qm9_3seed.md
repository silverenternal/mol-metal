...
Execution status: **complete**. Total wall: 21.30s.
...
```json
{
  ...
  "dtype": "float32",
  "ot": "POT sinkhorn_log, reg=0.05,max_iter=200, greedy hard projection; one compatible group of 8 per training batch",
...
|---|---|---:|---:|---:|---:|---:|
| 42 | False | 11.897688 | 5.865505 | 11.452600 | 6.479826 | 0.486 |
| 42 | True | 11.949752 | 4.989156 | 11.452600 | 6.318030 | 0.970 |
| 0 | False | 5.562124 | 6.135728 | 6.578252 | 5.892367 | 0.205 |
| 0 | True | 5.019954 | 4.556924 | 6.578252 | 5.814198 | 0.860 |
| 1234 | False | 9.934014 | 5.095097 | 11.945149 | 5.455019 | 0.213 |
| 1234 | True | 8.853271 | 4.800961 | 11.945148 | 5.443971 | 0.865 |

Paired common-validation differences (OT minus off; negative is lower): -0.161796, -0.078169, -0.011048
Mean ± sample std across 3 seeds: **-0.083671 ± 0.075525** (ddof=1).
...
|---|---|---|---|---:|---:|
| 42 | {'pot_sinkhorn_log': 30} | ['cuda:0'] | [] | 0.124993443 | 77524992 |
| 0 | {'pot_sinkhorn_log': 30} | ['cuda:0'] | [] | 0.125008702 | 77524992 |
| 1234 | {'pot_sinkhorn_log': 30} | ['cuda:0'] | [] | 0.124993443 | 77524992 |
...
**Finite soft plans do not certify convergence.** The fixed reg=0.05/max_iter=200 budget must be interpreted alongside the reported marginal residuals. These losses are descriptive micro-experiment results, not evidence for converged OT, large-scale convergence, general superiority, molecular quality, or better Vina scores. The subset is small and selected for compatible atom signatures.

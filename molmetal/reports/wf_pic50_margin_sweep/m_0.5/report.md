...
Loss: `MSE(exact) + hinge-margin(censored, margin=0.5)`.

| Seed | n_train/val/test | Test RMSE | Test Pearson r | n_exact_test | n_censored_test | bound_aware_accuracy |
|---|---:|---:|---:|---:|---:|---:|
| 42 | 1173/152/126 | 0.6796 | -0.0250 | 108 | 18 | 1.000 |
| 0 | 1150/162/139 | 0.6425 | 0.5186 | 106 | 33 | 1.000 |
| 1234 | 1181/138/132 | 0.7352 | 0.0920 | 116 | 16 | 1.000 |

Aggregate Pearson r: **0.1952 ± 0.2336** (target band 0.5–0.7, historical D-MPNN 0.407, ridge ref 0.5723).

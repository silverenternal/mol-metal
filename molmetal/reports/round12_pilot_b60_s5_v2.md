...
- **SA mean (1-10, lower=easier):** —
- **QED mean (0-1, higher=better):** —
- **Vina-proxy top-1 mean:** —
- **wall seconds/pocket:** 3.85

## Method

- MCTSProofSearch with n_simulations=5, max_depth=3
...
|---|---:|---:|---:|---|---|
| **Lambda (R4-C, measured)** | 2026 | — (proxy) | 0.000 | **MEASURED** (1/1 pockets) | this sweep |

...
\newcommand{\redex}{\mathsf{redex}}
\newcommand{\sn}{\mathsf{SN}}
\newcommand{\crprop}{\mathsf{CR}}
\newcommand{\dom}{\mathsf{dom}}
\newcommand{\fv}{\mathsf{FV}}
\newcommand{\subst}[3]{[#1:=#2]#3}
\newcommand{\stepsto}{\longrightarrow}
\newcommand{\stepstoBeta}{\longrightarrow_{\beta}}
\newcommand{\stepstoChem}{\longrightarrow_{\chi}}
\newcommand{\stepstoAll}{\longrightarrow_{\bnf}}

\title{Appendix: Formal Semantics of $\beta$-NF and the AST calculus \\
\large Supplementary material for the Lambda-Metal hybrid review}
\author{Mol-Metal hybrid working group}
\date{\today}
...
\bibitem{Barendregt1984}
  Henk~P. Barendregt.
  \emph{The Lambda Calculus: Its Syntax and Semantics}, volume 103 of
  \emph{Studies in Logic and the Foundations of Mathematics}.
  North-Holland, 1984.

\bibitem{Girard1989}
  Jean-Yves Girard, Yves Lafont, and Paul Taylor.
  \emph{Proofs and Types}, volume~7 of \emph{Cambridge Tracts in
